...
use TSEP\Bundle\SearchBundle\Entity\Search;
use TSEP\Bundle\SearchBundle\Form\SearchFormType;
use TSEP\Bundle\SearchBundle\Form\PageType;
    ...
    public function searchAction () {
        ...
        if($request->getMethod() == 'POST') {
            ...
            if($form->isValid()) {
                ...
                $results = $em->getRepository('TSEPSearchBundle:Page')->findBySearchQuery($search->getQuery());
            }
        }
